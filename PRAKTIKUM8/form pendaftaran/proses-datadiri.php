...
include 'koneksi.php';
    ...
    $namaneg = $_POST['namaneg'];
      ...
      $sql = mysqli_query($koneksi, "INSERT INTO datapribadi (namaleng, jkelamin, nisn, nik, tlahir, tglahir, agama, berkebkhusus, alamat, rt, rw, namadusun, namakel, kec, kodepos, ttinggal, transport, nohp, notelp, email, kpspkh, nokpspkh, kwn, namaneg) VALUES ('$namaleng', '$jkelamin', '$nisn', '$nik', '$tlahir', '$tglahir', '$agama', '$berkebkhusus', '$alamat', '$rt', '$rw', '$namadusun', '$namakel', '$kec', '$kodepos', '$ttinggal', '$transport', '$nohp', '$notelp', '$email', '$kpspkh', '$nokpspkh', '$kwn', '$namaneg')");
      if ($sql) {
          // pesan jika data tersimpan
          echo "<script>alert('Selanjutnya Mengisi Form Data Ayah!'); window.location.href='form-datayah.php'</script>"; 
        } else {
