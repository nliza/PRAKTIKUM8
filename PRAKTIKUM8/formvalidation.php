...
<html>
    <head>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.cs" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NFXoaoApnYnB1iuXoPkFOJwJBERdknLPMO" crossorigin="anonymous">
        <style>
    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            { 
                ...
                if (!preg_match("/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%?=~_|l/i",$web))
                {
